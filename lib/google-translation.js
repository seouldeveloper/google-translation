...
client.translate = function(obj, callback){
  ...
  if (requestModel === "nmt") {
	  client.getToken(function(token) {
		  if(source) {
			  url = 'https://translation.googleapis.com/language/translate/v2?key=' + client.apiKey + '&q=' + encodeURIComponent(text) + '&source=' + source + '&target=' + target + "&model=nmt";
		  } else {
			  url = 'https://translation.googleapis.com/language/translate/v2?key=' + client.apiKey + '&q=' + encodeURIComponent(text) + '&target=' + target + "&model=nmt";
		  }
		  url = 'https://translation.googleapis.com/language/translate/v2?key=' + client.apiKey + '&q=' + encodeURIComponent(text) + '&target=' + target + "&model=nmt";
		  options = {
			  url,
	  ...
	  if(source) {
		  url = 'https://translation.googleapis.com/language/translate/v2?key=' + client.apiKey + '&q=' + encodeURIComponent(text) + '&source=' + source + '&target=' + target + "&model=base";
	  } else {
		  url = 'https://translation.googleapis.com/language/translate/v2?key=' + client.apiKey + '&q=' + encodeURIComponent(text) + '&target=' + target + "&model=base";
	  }
	  url = 'https://translation.googleapis.com/language/translate/v2?key=' + client.apiKey + '&q=' + encodeURIComponent(text) + '&target=' + target + "&model=base";
	  options = {
		  url,
